    ...
    return (
        <div className="flex flex-col xl:flex-row w-full gap-8 pb-10">
            ...
            <div className="flex-1 space-y-8">
                <StudentTopbar />
                {/* Hero Banner — pt-7 creates space for model head to peek above card */}
                <div className="relative pt-7">
                    ...
                    {/* Model — head peeks above card in pt-7 gap */}
                    <div className="absolute right-0 top-0 bottom-0 w-[380px] pointer-events-none">
                        <Image
                            src="/hero-three-girssls.png"
                            alt="Students"
                            fill
